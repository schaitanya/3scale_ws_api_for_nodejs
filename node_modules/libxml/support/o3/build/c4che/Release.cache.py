AR = '/usr/bin/ar'
ARFLAGS = 'rcs'
CCFLAGS = ['-g', '-O3', '-msse2', '-ffast-math', '-fno-strict-aliasing']
...
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-O3', '-msse2', '-ffast-math', '-fno-strict-aliasing']
CXXFLAGS_DEBUG = ['-g']
...
LIBDIR = '/Users/chaitanya/.node_libraries'
LIBPATH_NODE = '/opt/local/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/chaitanya/.node_libraries'
PREFIX = '/usr/local'
